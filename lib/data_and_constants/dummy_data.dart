import 'package:complex_ui_assignment/models/music_model.dart';
  ...
  static List artistsList = [
    ...
    ArtistsModel(
      ...
      songs: [
        MusicModel(
            ...
            musicName: 'StarBoy'),
        MusicModel(
            imageUrl: 'assets/images/without-you.jpeg', musicName: 'Reminder'),
        MusicModel(
            imageUrl: 'assets/images/save-your-tears.jpeg',
    ...
    ArtistsModel(
      ...
      songs: [
        ...
        MusicModel(
            imageUrl: 'assets/images/without-you.jpeg', musicName: 'Acid Rain'),
        MusicModel(
            imageUrl: 'assets/images/save-your-tears.jpeg',
